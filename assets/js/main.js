...
<div class="nav-wrapper">
    ...
    <ul class="right hide-on-med-and-down">
        ...
        <li><a class="white-text" href="https://hashnode.com/@Ayush7614" target="_blank">Blog</a></li>
        <li><a class="white-text" href="https://www.stopstalk.com/user/profile/ayushknj3" target="_blank">CP Profile</a></li>
    ...
    <div class="row">
      ...
      <div class="col-sm-6 col-md-7">
        ...
        <div class="simple-text text-center dark padding-sm">
          <p >
            "I’m a curious little ECE sophomore looking to create impact with what I learn."
          </p>
...
<div class="social-icons-footer">
  <a class="social-icon-footer twitter" href="https://twitter.com/AyushKu38757918" target="_blank" rel="author">
    <i class="fab fa-twitter"></i>
      </a>
  <a class="social-icon-footer github" href="https://github.com/Ayush7614" target="_blank" rel="author">
    <i class="fab fa-github"></i>
      </a>
  <a class="social-icon-footer linkedin" href="https://linkedin.com/in/ayush-kumar-984443191" target="_blank" rel="author">
    <i class="fab fa-linkedin-in"></i>
      </a>
  <a class="social-icon-footer instagram" href="https://instagram.com/ayush_msdian" target="_blank" rel="author">
    <i class="fab fa-instagram"></i>
      </a>
  <a class="social-icon-footer dev" href="https://devfolio.co/@ayushknj3" target="_blank" rel="author">
    <i class="fab fa-dev"></i>
      </a>

  <a class="social-icon-footer envelope" href="mailto:ayushknj3@gmail.com" target="_blank" rel="author">
